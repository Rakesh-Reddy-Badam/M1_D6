...
*/
    ...
    me.skills=['Java_Script', 'Python', 'HTML', 'CSS']
    console.log(me)
/* Ex.G 
...
*/
    ...
    console.log(splitMe('My Name is Rakesh Reddy'))
/* Ex.4
    Write a function called "deleteOne" which receives a string and a boolean as parameters. If the boolean value is true it should return the string without the first letter, otherwise it should remove the last one from it.
*/
    const deleteOne=function(a,b){
        if(b){
            return a.slice(1)
        }
        else{
    ...
    console.log(deleteOne('rakesh',false))
/* Ex.5
...
*/
    ...
    console.log(onlyLetters('rakeshreddy6084'))
    console.log(typeof 6084)
/* Ex.6 
...
*/
    const deleteProp= function(myObject,Mystring){
        delete myObject[Mystring]
        return myObject
    }
    const myObject={name:'rakeshReddy',age:27}
...
*/
    const olderMovie= function(){
        ...
        for(i=0;i<movies.length;i++){
            ...
            let minYear=Math.min(...movieYear)
            for(i=0;i<movies.length;i++){
                if(parseInt(movies[i].Year)===minYear){
                    movieTitle=movies[i].Title
                    return 'Oldest MOvie In the album is '+movieTitle
            }
         }
        }
